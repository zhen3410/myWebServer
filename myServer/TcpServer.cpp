...
void TcpServer::newConnection(){
    ...
    newConn->setCloseCallBack(std::bind(TcpServer::ConnectioncloseCallBack_,this,std::placeholders::_1));
}

void TcpServer::ConnectionCloseCallBack_(const std::string& name){
